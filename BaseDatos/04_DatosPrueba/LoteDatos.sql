...
-- ============================================================
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=4, @Nombre='Melissa', @Apellido1='Araya', @Apellido2='Rojas', @Telefono='81109031', @Email='melissa.araya1@correo.com', @Direccion='Guanacaste, 462 metros sur de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=1, @Nombre='Esteban', @Apellido1='Gonzalez', @Apellido2='Rojas', @Telefono='83608513', @Email='esteban.gonzalez2@correo.com', @Direccion='Alajuela, 440 metros este de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=3, @Nombre='Kenneth', @Apellido1='Mora', @Apellido2='Salazar', @Telefono='82622631', @Email='kenneth.mora3@correo.com', @Direccion='Heredia, 483 metros este de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=3, @Nombre='Mauricio', @Apellido1='Jimenez', @Apellido2='Quesada', @Telefono='89996414', @Email='mauricio.jimenez4@correo.com', @Direccion='San Jose, 243 metros norte de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=2, @Nombre='Jorge', @Apellido1='Duran', @Apellido2='Chaves', @Telefono='84226067', @Email='jorge.duran5@correo.com', @Direccion='Limon, 85 metros norte de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=3, @Nombre='Diego', @Apellido1='Fernandez', @Apellido2='Mora', @Telefono='84905582', @Email='diego.fernandez6@correo.com', @Direccion='Guanacaste, 101 metros oeste de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=3, @Nombre='Laura', @Apellido1='Quesada', @Apellido2='Chaves', @Telefono='83728882', @Email='laura.quesada7@correo.com', @Direccion='Heredia, 231 metros sur de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=2, @Nombre='Ricardo', @Apellido1='Mora', @Apellido2='Duran', @Telefono='83871230', @Email='ricardo.mora8@correo.com', @Direccion='Puntarenas, 423 metros sur de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=3, @Nombre='Gabriela', @Apellido1='Quesada', @Apellido2='Salazar', @Telefono='85528972', @Email='gabriela.quesada9@correo.com', @Direccion='Limon, 402 metros sur de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=3, @Nombre='Vanessa', @Apellido1='Jimenez', @Apellido2='Alvarado', @Telefono='81538552', @Email='vanessa.jimenez10@correo.com', @Direccion='Guanacaste, 211 metros oeste de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=4, @Nombre='Karla', @Apellido1='Mora', @Apellido2='Chacon', @Telefono='86279418', @Email='karla.mora11@correo.com', @Direccion='Alajuela, 385 metros oeste de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=4, @Nombre='Yolanda', @Apellido1='Quesada', @Apellido2='Solano', @Telefono='85443951', @Email='yolanda.quesada12@correo.com', @Direccion='Alajuela, 176 metros este de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=1, @Nombre='Sofia', @Apellido1='Araya', @Apellido2='Salazar', @Telefono='87073292', @Email='sofia.araya13@correo.com', @Direccion='Alajuela, 120 metros oeste de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=1, @Nombre='Paola', @Apellido1='Jimenez', @Apellido2='Vargas', @Telefono='83564251', @Email='paola.jimenez14@correo.com', @Direccion='Limon, 131 metros oeste de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=1, @Nombre='Federico', @Apellido1='Salazar', @Apellido2='Salazar', @Telefono='88852574', @Email='federico.salazar15@correo.com', @Direccion='Puntarenas, 178 metros norte de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=2, @Nombre='Karen', @Apellido1='Camacho', @Apellido2='Rojas', @Telefono='86707197', @Email='karen.camacho16@correo.com', @Direccion='San Jose, 200 metros oeste de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=1, @Nombre='Jose', @Apellido1='Quesada', @Apellido2='Rodriguez', @Telefono='85418934', @Email='jose.quesada17@correo.com', @Direccion='Puntarenas, 440 metros sur de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=1, @Nombre='Mariela', @Apellido1='Fernandez', @Apellido2='Villalobos', @Telefono='84337174', @Email='mariela.fernandez18@correo.com', @Direccion='Alajuela, 241 metros sur de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=3, @Nombre='Alejandro', @Apellido1='Duran', @Apellido2='Gonzalez', @Telefono='89197443', @Email='alejandro.duran19@correo.com', @Direccion='San Jose, 107 metros este de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=4, @Nombre='Carlos', @Apellido1='Alvarado', @Apellido2='Jimenez', @Telefono='85041154', @Email='carlos.alvarado20@correo.com', @Direccion='Puntarenas, 90 metros norte de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=2, @Nombre='Silvia', @Apellido1='Mora', @Apellido2='Camacho', @Telefono='83109911', @Email='silvia.mora21@correo.com', @Direccion='Alajuela, 387 metros oeste de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=3, @Nombre='Oscar', @Apellido1='Rojas', @Apellido2='Villalobos', @Telefono='88099076', @Email='oscar.rojas22@correo.com', @Direccion='Alajuela, 326 metros sur de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=2, @Nombre='Luis', @Apellido1='Salazar', @Apellido2='Chaves', @Telefono='88350099', @Email='luis.salazar23@correo.com', @Direccion='Puntarenas, 281 metros norte de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=2, @Nombre='Rodrigo', @Apellido1='Alvarado', @Apellido2='Mora', @Telefono='86672134', @Email='rodrigo.alvarado24@correo.com', @Direccion='San Jose, 351 metros sur de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=3, @Nombre='Fabiola', @Apellido1='Rodriguez', @Apellido2='Mora', @Telefono='81987737', @Email='fabiola.rodriguez25@correo.com', @Direccion='Alajuela, 84 metros norte de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=2, @Nombre='Andres', @Apellido1='Mora', @Apellido2='Villalobos', @Telefono='84993055', @Email='andres.mora26@correo.com', @Direccion='Heredia, 392 metros oeste de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=4, @Nombre='Natalia', @Apellido1='Camacho', @Apellido2='Solano', @Telefono='88930103', @Email='natalia.camacho27@correo.com', @Direccion='Alajuela, 451 metros oeste de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=4, @Nombre='Maria', @Apellido1='Chacon', @Apellido2='Vargas', @Telefono='82626229', @Email='maria.chacon28@correo.com', @Direccion='Limon, 270 metros este de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=1, @Nombre='Ana', @Apellido1='Zuniga', @Apellido2='Quesada', @Telefono='81908841', @Email='ana.zuniga29@correo.com', @Direccion='Limon, 384 metros norte de la iglesia', @Estado='A', @IdUsuarioGlobal=1
EXEC SP_INSERTA_PROPIETARIOS @Id_Tipo_Identificacion=4, @Nombre='Manuel', @Apellido1='Salazar', @Apellido2='Gonzalez', @Telefono='82833230', @Email='manuel.salazar30@correo.com', @Direccion='Alajuela, 148 metros sur de la iglesia', @Estado='A', @IdUsuarioGlobal=1
GO
