...
namespace BLL_VETNOVA.Entidades
{
    ...
    {
        // SELECT sin filtro -> SP_LISTAR_TIPOS_IDENTIFICACION
        public void ListarTiposIdentificacion(ref cls_Tipos_Identificacion_DAL obj_TiposIdentificacion_DAL)
        {
            try
            {
                ...
                obj_BD_DAL.sNomSP = ConfigurationManager.AppSettings["SP_LISTAR_TiposIdentificacion"].ToString();
